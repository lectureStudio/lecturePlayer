...
import { RectangleShape } from "../model/shape/rectangle.shape.js";
...
describe("RectangleRenderer", () => {
	...
	beforeEach(async () => {
		...
		shape = new RectangleShape(0, new Brush(Color.fromHex("#000"), 1));
	...
	it("render empty shape", () => {
		const shape = new RectangleShape(0, new Brush(Color.fromHex("#000"), 1));
