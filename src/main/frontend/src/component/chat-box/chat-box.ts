	...
	render() {
		return html`
			...
			<div class="chat-controls">
				<button @click="${this.submit}" type="submit" class="btn btn-outline-primary btn-sm" id="messageSubmit" form="course-message-form">
					<span>${t("course.feature.message.send")}</span>
