...
export class StreamActionParser {
	...
	static parse(dataView: ProgressiveDataView, type: StreamActionType, length: number): StreamAction | null {
	...
	private static playbackAction(dataView: ProgressiveDataView): StreamPagePlaybackAction | null {
